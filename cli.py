...
Fit and use fuzzy-c-medians models to clustering.

You probably want to install completion for the typer command.
If you are using bash, try to type:

$ FCMid --install-completion bash

https://github.com/omadson/fuzzy-c-medians
"""
import pickle
import time
...
def fit(
    ...
    """Train and save a fuzzy-c-medians model given a dataset."""
    ...
    try:
        ...
        typer.echo(
            ...
            "https://github.com/omadson/fuzzy-c-medians/issues"
        )
        raise typer.Abort()
    if not quiet:
...
def predict(
    ...
    """Predict labels given a data set and a fuzzy-c-medians saved model."""
    X = _read_data(dataset_path, delimiter, quiet)
    if not quiet:
